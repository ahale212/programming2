...
public class StaffTest {
	...
	String employeeNumber, invalidEmployeeNumber, firstName,
	invalidFirstName, lastName, invalidLastName, employeeUsername, invalidEmployeeUsername,
	employeePassword, invalidEmployeePassword, employeeEmail, invalidEmployeeEmail;
	...
	/**
	 * method testing the constructor with args, including the encryption for password
	 */
		@Test
		public void testStaffStringStringStringStringStringString() {
			Staff staff = new Staff(employeeNumber, firstName, lastName, employeeUsername, employeePassword, employeeEmail);
