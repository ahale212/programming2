 ...
 * This contains the encryption of the password to match that of the database
 * @param employeePassword
 * @return
 */
	public String setEmployeePassword(String employeePassword) {
		...
		// for loop to loop through the password and change each character the specificed number of places set by the constant
 ...
 * note that the employee email must include an @ symbol otherwise it throws and exception
 * @return
 */
